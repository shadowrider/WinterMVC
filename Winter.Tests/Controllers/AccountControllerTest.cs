...
using Winter.BackEnd;
using Winter.BackEnd.Controllers;
using System.Collections.Generic;

namespace Winter.Tests.Controllers
{

    [TestClass]
    public class AccountControllerTest
    {
       /* private SelectListItem userRoles = /*new SelectList(new List<SelectListItem>() { 
        ...
        public void RegisterPostRedirectsHomeIfRegistrationSuccessful()
        {
            ...
            // Act
            RedirectToRouteResult result = (RedirectToRouteResult)controller.Register("someUser", "email", "goodPass", "goodPass", userRoles);
        ...
        public void RegisterPostReturnsViewIfEmailNotSpecified()
        {
            ...
            // Act
            ViewResult result = (ViewResult)controller.Register("username", "", "password", "password", userRoles);
        ...
        public void RegisterPostReturnsViewIfNewPasswordDoesNotMatchConfirmPassword()
        {
            ...
            // Act
            ViewResult result = (ViewResult)controller.Register("username", "email", "password", "password2", userRoles);
        ...
        public void RegisterPostReturnsViewIfPasswordIsNull()
        {
            ...
            // Act
            ViewResult result = (ViewResult)controller.Register("username", "email", null, null, userRoles);
        ...
        public void RegisterPostReturnsViewIfPasswordIsTooShort()
        {
            ...
            // Act
            ViewResult result = (ViewResult)controller.Register("username", "email", "12345", "12345", userRoles);
        ...
        public void RegisterPostReturnsViewIfRegistrationFails()
        {
            ...
            // Act
            ViewResult result = (ViewResult)controller.Register("someUser", "DuplicateUserName" /* error */, "badPass", "badPass", userRoles);
        ...
        public void RegisterPostReturnsViewIfUsernameNotSpecified()
        {
            ...
            // Act
            ViewResult result = (ViewResult)controller.Register("", "email", "password", "password", userRoles);
